...
function InternDetail() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await axios.get(`https://backend-internspot.onrender.com/api/internship/${id}`);
  ...
  const submitApplication = async () => {
    ...
    if (text.value === "") {
      ...
      await axios.post("https://backend-internspot.onrender.com/api/application", bodyJson).then((res) => {
          ...
          <>
            ...
            <div className="m-14 shadow-sm rounded-md border">
              ...
              <div className="flex tedxt-sm justify-between">
                ...
                <p className='mt-3 text-slate-400'> <i className="bi bi-calendar-check-fill"></i> Duration <br /> {data.Duration}</p>
