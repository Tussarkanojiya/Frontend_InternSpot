  ...
  return (
    <div>
      <div className='form'>
        ...
        <p className='para3'>1,50,000+ companies hiring on InternSpot</p>
        <div className="regi">
        <div className="py-6">
          ...
          isDivVisible &&(
            ...
            {isStudent?(
              ...
              <div className="py-6">
                ...
                <div className="w-full p-8 lg:w-1/2">
                  <p onClick={handleSingin} className='flex items-center h-9 justify-center mt-4 text-white bg-slate-100 rounded-lg hover:bg-gray-100'>
                    ...
                    <h1 className=' text-gray-600'>Login with Google</h1>
                  </p>
