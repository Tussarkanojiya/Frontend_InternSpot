...
function Job() {
    ...
    useEffect(()=>{
        const fetchData= async()=>{
            try {
            const response= await axios.get(`https://backend-internspot.onrender.com/api/job`)
  ...
  return (
    ...
    <div className="info-intern mt-16">
    <div className="mt-12">
            <h1 className='text-center font-bold'>Latest Jobs on Intern Spot</h1>
        </div>
